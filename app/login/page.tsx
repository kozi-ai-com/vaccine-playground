              ...
              <CardContent className="grid p-0 md:grid-cols-2">
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col items-center gap-2 text-center">
                      ...
                      <p className="text-balance text-sm text-muted-foreground">
                        Sign in to the Kozi AI platform
                      </p>
                    </div>
                    ...
                    {sessionExpired && !error && (
                      <div className="flex items-start gap-3 rounded-lg border border-border bg-muted px-4 py-3">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          Your session ended. Results from any pipeline runs you submitted are
                          preserved — you&apos;ll find them in your history after signing in.
                        </p>
                      </div>
                    )}
                ...
                <div className="relative hidden bg-gradient-to-br from-primary via-primary to-primary/80 md:flex md:flex-col md:items-center md:justify-center md:p-10">
                  ...
                  <div className="relative z-10 flex flex-col items-center text-center text-primary-foreground max-w-xs">
                    <div className="flex size-16 items-center justify-center rounded-2xl bg-primary-foreground/10 backdrop-blur-sm mb-8">
                      <IconFlask className="size-8 text-primary-foreground" />
                    </div>
                    <p className="text-base font-medium leading-relaxed text-primary-foreground/90">
                      &ldquo;From pathogen to candidate epitopes in minutes, not weeks.&rdquo;
                    </p>
